 ...
 */
router.get("/",auth, getPrintingServices);
 ...
 *         description: Server error
 */
router.post("/",auth, createPrintingService);
/**
 * @swagger
 ...
 *         description: Server error
 */
router.put("/:id",auth, updatePrintingService);
/**
 * @swagger
 * /api/printing-services/{id}:
 *   delete:
 ...
 *         description: Server error
 */
router.delete("/:id",auth, deletePrintingService);
